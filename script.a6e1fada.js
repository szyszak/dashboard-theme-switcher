...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/theme.js":[function(require,module,exports) {
"use strict";
...
var getInitialTheme = function getInitialTheme() {
  ...
  var persistedTheme = window.localStorage.getItem('theme');
  var hasPersistedPreference = typeof persistedTheme === 'string';
  ...
  var hasMediaQueryPreference = typeof mediaQueryList.matches === 'boolean'; // use theme preferred by used
...
var setTheme = function setTheme(newTheme) {
  ...
  localStorage.setItem('theme', newTheme); // update theme toggle state
  ...
  var currentTheme = newTheme === 'light' ? _theme.light : _theme.dark; // change CSS variables according to theme

  for (var _i = 0, _Object$entries = Object.entries(currentTheme); _i < _Object$entries.length; _i++) {
...
toggle.addEventListener('change', function (ev) {
  return setTheme(ev.target.checked ? 'dark' : 'light');
});
},{"./theme":"scripts/theme.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
